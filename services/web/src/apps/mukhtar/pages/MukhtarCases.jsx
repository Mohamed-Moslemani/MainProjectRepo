...
const DOC_TYPE_LABELS = {
  ...
  old_passport_data_page_top: { ar: 'الجواز القديم - النصف العلوي (الصورة)', en: 'Old Passport – Top Half (Photo)' },
  old_passport_data_page_bottom: { ar: 'الجواز القديم - النصف السفلي (MRZ)', en: 'Old Passport – Bottom Half (MRZ)' },
  passport_data_page_top: { ar: 'الجواز - النصف العلوي (الصورة)', en: 'Passport – Top Half (Photo)' },
  passport_data_page_bottom: { ar: 'الجواز - النصف السفلي (MRZ)', en: 'Passport – Bottom Half (MRZ)' },

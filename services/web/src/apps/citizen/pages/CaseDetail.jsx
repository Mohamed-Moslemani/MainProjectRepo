...
const DOC_LABELS = {
  ...
  old_passport_data_page_top:    { ar: 'الجواز القديم - النصف العلوي', en: 'Old Passport – Top Half' },
  old_passport_data_page_bottom: { ar: 'الجواز القديم - النصف السفلي', en: 'Old Passport – Bottom Half' },

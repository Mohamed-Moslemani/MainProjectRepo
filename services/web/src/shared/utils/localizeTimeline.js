...
const DOC_TYPE_AR = {
  ...
  passport_data_page_top: 'الجواز - النصف العلوي (الصورة)',
  passport_data_page_bottom: 'الجواز - النصف السفلي (MRZ)',
  old_passport_data_page_top: 'الجواز القديم - النصف العلوي',
  old_passport_data_page_bottom: 'الجواز القديم - النصف السفلي',
...
const DOC_TYPE_EN = {
  ...
  passport_data_page_top: 'Passport – Top Half (Photo)',
  passport_data_page_bottom: 'Passport – Bottom Half (MRZ)',
  old_passport_data_page_top: 'Old Passport – Top Half',
  old_passport_data_page_bottom: 'Old Passport – Bottom Half',
